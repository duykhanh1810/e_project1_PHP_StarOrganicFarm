<?php 
session_start(); require "admin/adminFunction.php"
                ...
                <div class="row">
                    <div id="login" class="col-md-9">
                        <form action="login_logic.php" id="login-form" class="myform" method="post">
                            ...
                            <input type="text" name="email" id="email"  required="required" placeholder="enter email" value="<?=isset($_GET['email']) ? $_GET['email'] : '' ?>">
                            <label for="password">Password:</label>
                            <input type="password" name="pass" id="password"  required="required" placeholder="enter password">
                            <input type="submit" name='login' value="login">
                        </form>
                        <p class="create-acc">Customer's account allow us to track your orders for the best services. </p>
                        <p class="create-acc">If you don't have an account yet, please <a href="create-account.php">create one.</a></p>
                    </div>
                </div><!-- /row-->
            </div><!--/main-->
        </div><!--/content-->
