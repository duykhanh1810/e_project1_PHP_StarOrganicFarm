...
--
DROP TRIGGER IF EXISTS `totalValue_Delete`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `totalValue_Update`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `unitprice`;
DELIMITER $$
...
(24, 'Onion', 0.99, 'Most plants of the genus Onion are collectively referred to as onions. In practice, however, the word onion is generally used to refer to a plant species with the dichotomous name Allium cepa. \r\nOnions are considered both a spice and a vegetable that are rich in Potassium, Selenium, Vitamin C and Quercetin. Red onions are rich in sulfur compounds and groups such as DMS, DDS, DTS &amp; DTTS that cause a pungent odor.', 3, 1, 'imgs/hanh-tay.jpg'),
(25, 'Chili powder', 1.25, 'Chili powder is the dried, pulverized fruit of one or more varieties of chili pepper, sometimes with the addition of other spices. \r\nIt is used as a spice to add pungency and flavor to culinary dishes. In American English, the spelling is usually &quot;chili&quot;; in British English, &quot;chilli&quot; is used consistently.', 3, 1, 'imgs/bot-ot.jpg'),
(26, 'Grape', 1.99, 'Grapes contain powerful antioxidants known as polyphenols. These are thought to have anti-inflammatory and antioxidant properties. One of these is resveratrol. It is found in the skins of red grapes.\r\n\r\nLaboratory studies have suggested that resveratrol may be able to slow or prevent the growth of tumors in lymph, liver, stomach, breast, colon, skin cancer, and leukemia.', 1, 1, 'imgs/nho.jpg'),
(27, 'Brown rice', 15.99, 'Brown rice, also known as Rice Bran is a type of rice with only the husk removed and the bran layer removed. \r\nThis rice is very rich in nutrients, especially vitamins and trace elements.', 2, 1, 'imgs/lut.jpg'),
